 ...
 *
 * This file documents how to use the centralized HTTP client
 * for API communication in the DiWeiWei Nano Market frontend.
 */
...
// Import the httpClient from shared/api/httpClient.ts for actual usage
