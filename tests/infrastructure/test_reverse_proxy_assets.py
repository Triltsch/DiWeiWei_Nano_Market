...
def test_nginx_default_conf_contains_required_security_controls() -> None:
    ...
    required_fragments = (
        ...
        "limit_req_zone $binary_remote_addr zone=chat_messages:10m rate=100r/s;",
        "limit_req_zone $binary_remote_addr zone=nano_ratings:10m rate=50r/s;",
        "limit_req_zone $binary_remote_addr zone=api_default:10m rate=200r/s;",
        "limit_req_status 429;",
