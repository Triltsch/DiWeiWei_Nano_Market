...
- **Read through the peer review related comments carefully**: Review comments may be returned in different API responses than general comments. If the initial fetch shows no comments but the PR UI displays review feedback, use visual inspection or alternative data sources to locate all comments (including Copilot AI reviews, traditional comments, and inline suggestions).
